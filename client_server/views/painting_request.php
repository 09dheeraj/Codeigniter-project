<form id="drawingForm" class="needs-validation" action="<?php echo base_url(); ?>art_submit_form" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="tab d-none">
                            <div class="draw-section">
                                ...
                                <div class="draw-box d-flex profile-card m-0 position-relative p-0">
                                    <div class="controls">
                                        ...
                                        <input type="file" id="uploader"   accept="image/png, image/JPG, image/jpeg ,image/TIFF ,image/WEBP ,image/BMP"  />
                                            ...
                                            <label class="radio-img " data-bs-toggle="tooltip" data-bs-placement="right"
                                                ...
                                                <img src="<?php echo base_url(); ?>assets/images/rectangle.png"
                                                    alt="">
                                            ...
                                            <label data-bs-toggle="tooltip" data-bs-placement="right" title="Circle"
                                                ...
                                                <img src="<?php echo base_url(); ?>assets/images/circle-icon.png"
                                                    alt="">
                                            </label>
                                            <label data-bs-toggle="tooltip" data-bs-placement="right" title="Square"
                                                ...
                                                <img src="<?php echo base_url(); ?>assets/images/square-icon.png"
                                                    alt="">
                                            </label>
                                            <label data-bs-toggle="tooltip" data-bs-placement="right" title="Ellipse"
                                                ...
                                                <img src="<?php echo base_url(); ?>assets/images/elipse-icon.png"
                                                    alt="">
                                            </label>
                                            <label data-bs-toggle="tooltip" data-bs-placement="right" title="Polygon"
                                                ...
                                                <img src="<?php echo base_url(); ?>assets/images/polygon-icon.png"
                                                    alt="" >
                                            </label>
                                        ...
                                        <div class='lightBorder '>
                                            <label data-bs-toggle="tooltip" data-bs-placement="right" title="Line"
                                                class="radio-img "> <input class=" d-none icon" type="radio"
                                                    ...
                                                    src="<?php echo base_url(); ?>assets/images/line-icon.png"
                                                    alt=""></label>
                                            <label data-bs-toggle="tooltip" data-bs-placement="right" title="Freehand"
                                                ...
                                                <input class="d-none icon" type="radio" name="shape" id="freehandRadio"
                                                    value="freehand"><img
                                                    src="<?php echo base_url(); ?>assets/images/freehand-icon.png"
                                                    alt="">
                                            </label>
                                            <label data-bs-toggle="tooltip" data-bs-placement="right"
                                                ...
                                                <input class="d-none icon" type="radio" name="shape"
                                                    ...
                                                    src="<?php echo base_url(); ?>assets/images/spray-icon.png"
                                                    alt="">
                                            </label>
                                            <label data-bs-toggle="tooltip" data-bs-placement="right" title="Brush"
                                                ...
                                                <input class="d-none icon" type="radio" class="tool" name="shape"
                                                    ...
                                                    src="<?php echo base_url(); ?>assets/images/brush-icon.png"
                                                    alt="">
                                            </label>
                                            ...
                                            <label data-bs-toggle="tooltip" data-bs-placement="right"
                                                ...
                                                for="uploader"><img
                                                    src="<?php echo base_url(); ?>assets/images/uploadimage-icon.png"
                                                    alt=""></label>
                                            ...
                                            <div class="d-flex justify-content-start ">
                                                ...
                                                <button type="button"
                                                    ...
                                                    id="eraserButton" name="button"><img
                                                        src="<?php echo base_url(); ?>assets/images/eraser-icon.png"
                                                        alt=""></button>
                                            ...
                                            <button type="button"
                                                ...
                                                title="Clear Canvas" id="clearCanvas" name="button"><img
                                                    src="<?php echo base_url(); ?>assets/images/canvas-icon.png"
                                                    alt=""></button>
                                        </div>
                                    ...
                                    <canvas id="canvas" width="1574" height="650"></canvas>
...
document.getElementById("drawingForm").addEventListener("keydown", function (event) {
  if (event.target.tagName !== 'INPUT' && event.keyCode === 32) {
  ...
  //  ERASER_height = 20;
   ...
   const eraserButton12 = document.getElementById("eraserButton");
    ...
    function init() {
        ...
        var canvas_images_array = [];
        var image_name_array = [];
        var base64_image_array = [];
        let lastImageName = '';
        ...
        $('#uploader').on('click', function () {
            ...
            reader.onload = (event) => {
                ...
                imageLoader.value = '';
                string =  newImage.src+"HR2023";
           //--------------------------------------------------------------------------
           // push image name in array  
           ...
           if (file.name !== lastFileName) 
            ...
            string =  file.name+"HR24";
             console.log(string);
             lineData.push(string);
             const lineDataField = document.getElementById('lineDataField');
             lineDataField.value = JSON.stringify(lineData);
             const timestamp = new Date().getTime();
            const timestampedFileName = `${timestamp}_${file.name}`;
            //  $('#images_data').append(`<input type="text" name="image_name[]" id="image_name" value="${file.name}">`);
             $('#images_data').append(`<input type="hidden" name="image_name[]" id="image_name" value="${timestampedFileName}">`);
            $('#images_data').append(`<input type="hidden" name="canvasimage[]" id="canvasimage" value="${newImage.src}">`);
            }
            }
           else
           {
