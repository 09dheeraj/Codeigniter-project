        ...
        $('#uploader').on('click', function () {
           ...
           if (file.name !== lastFileName) 
            ...
            //  $('#images_data').append(`<input type="text" name="image_name[]" id="image_name" value="${file.name}">`);
             $('#images_data').append(`<input type="text" name="image_name[]" id="image_name" value="${timestampedFileName}">`);
            $('#images_data').append(`<input type="text" name="canvasimage[]" id="canvasimage" value="${newImage.src}">`);
                }
